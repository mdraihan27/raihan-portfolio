    ...
    <div ref={ref} className="">
      ...
      <div className="bg-[#00000095] border border-white/5 rounded-4xl p-5 sm:p-6 flex flex-col gap-6 md:gap-10 lg:flex-row lg:justify-between lg:gap-20">
        <div className="order-2 lg:order-1 ">
          <h1 className="text-stone-100 text-2xl text-center lg:text-left sm:text-3xl font-medium">
            Md. Raihan Hossen
          </h1>
          <p className="text-stone-100 text-sm text-center lg:text-left font-medium mt-4  leading-relaxed">
          ...
          <div className="e-full flex lg:justify-start justify-center">
            <a
